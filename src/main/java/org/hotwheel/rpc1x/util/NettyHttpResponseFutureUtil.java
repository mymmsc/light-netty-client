...
public class NettyHttpResponseFutureUtil {
    ...
    public static void attributeResponse(Channel channel, RpcResponseFuture<NettyHttpResponse> responseFuture) {
    ...
    public static RpcResponseFuture<NettyHttpResponse> getResponse(Channel channel) {
        return (RpcResponseFuture<NettyHttpResponse>) channel.attr(DEFAULT_ATTRIBUTE).get();
    }
    ...
    public static void setPendingResponse(Channel channel, HttpResponse pendingResponse) {
        RpcResponseFuture<NettyHttpResponse> responseFuture = getResponse(channel);
    ...
    public static void setPendingContent(Channel channel, HttpContent httpContent) {
        RpcResponseFuture<NettyHttpResponse> responseFuture = getResponse(channel);
        ResponseBuilder<NettyHttpResponse> responseBuilder = responseFuture.getResponseBuilder();
